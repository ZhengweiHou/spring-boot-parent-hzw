...
public class HzwHello$$EnhancerByCGLIB$$b2f16848
    ...
    public void setCallbacks(Callback[] arrcallback) {
        ...
        HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848 = this;
    ...
    private static final void CGLIB$BIND_CALLBACKS(Object object) {
        block2: {
            Object object2;
            block3: {
                HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848 = (HzwHello$$EnhancerByCGLIB$$b2f16848)object;
                if (hzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$BOUND) break block2;
                hzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$BOUND = true;
                object2 = CGLIB$THREAD_CALLBACKS.get();
                if (object2 != null) break block3;
                object2 = CGLIB$STATIC_CALLBACKS;
                if (CGLIB$STATIC_CALLBACKS == null) break block2;
            }
//            hzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$CALLBACK_0 = (MethodInterceptor)((Callback[])object2)[0];
        }
    }
    ...
    static void CGLIB$STATICHOOK1() throws ClassNotFoundException {
        ...
        Class<?> class_ = Class.forName("com.hzw.learn.springboot.springbase.AOP.CGLIB.HzwHello$$EnhancerByCGLIB$$b2f16848");
    ...
    public HzwHello$$EnhancerByCGLIB$$b2f16848() {
        HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848 = this;
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$BIND_CALLBACKS(hzwHello$$EnhancerByCGLIB$$b2f16848);
    }

    static {
        try {
            HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$STATICHOOK1();
    ...
    public Object newInstance(Callback[] arrcallback) {
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$SET_THREAD_CALLBACKS(arrcallback);
        HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848 = new HzwHello$$EnhancerByCGLIB$$b2f16848();
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$SET_THREAD_CALLBACKS(null);
        return hzwHello$$EnhancerByCGLIB$$b2f16848;
    }

    public Object newInstance(Class[] arrclass, Object[] arrobject, Callback[] arrcallback) {
        HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848;
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$SET_THREAD_CALLBACKS(arrcallback);
        Class[] arrclass2 = arrclass;
        switch (arrclass.length) {
            case 0: {
                hzwHello$$EnhancerByCGLIB$$b2f16848 = new HzwHello$$EnhancerByCGLIB$$b2f16848();
                break;
            }
            default: {
    ...
    public Object newInstance(Callback callback) {
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$SET_THREAD_CALLBACKS(new Callback[]{callback});
        HzwHello$$EnhancerByCGLIB$$b2f16848 hzwHello$$EnhancerByCGLIB$$b2f16848 = new HzwHello$$EnhancerByCGLIB$$b2f16848();
        HzwHello$$EnhancerByCGLIB$$b2f16848.CGLIB$SET_THREAD_CALLBACKS(null);
        return hzwHello$$EnhancerByCGLIB$$b2f16848;
    }
