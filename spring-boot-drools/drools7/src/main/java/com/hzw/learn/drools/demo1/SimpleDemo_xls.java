...
//		Resource resourceFile = ResourceFactory.newInputStreamResource(route1Stream, "UTF-8");
		Resource resourceFile = ResourceFactory.newClassPathResource("drools/SimpleDemo.xls","UTF-8");
		...
		kbuilder.add(resourceFile, ResourceType.DTABLE,dtconf);

		// 第二个规则sheet页
		DecisionTableConfiguration dtconf2 = KnowledgeBuilderFactory.newDecisionTableConfiguration();
		dtconf2.setInputType(DecisionTableInputType.XLS);
		dtconf2.setWorksheetName("S2");

		kbuilder.add(resourceFile, ResourceType.DTABLE,dtconf2);
