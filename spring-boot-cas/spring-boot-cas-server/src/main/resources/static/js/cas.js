...
function checkCodeImgChange() {
    var path = document.location.pathname.replace(/login/, "getcheckcode");
    document.getElementById("checkCodeImg").src = path + '?' + new Date().getTime();
}
